...
namespace HKX2
{
    public partial class hkaiNavMeshGenerationSettingsRegionPruningSettings : IHavokObject
    {
        ...
        public virtual void Read(PackFileDeserializer des, BinaryReaderEx br)
        {
            ...
            m_regionConnections = des.ReadClassArray<hkaiNavMeshGenerationSettingsRegionPruningSettingsRegionConnection>(br);
        }
        ...
        public virtual void Write(PackFileSerializer s, BinaryWriterEx bw)
        {
            ...
            s.WriteClassArray<hkaiNavMeshGenerationSettingsRegionPruningSettingsRegionConnection>(bw, m_regionConnections);
        }
    }
}
